...
import com.qujing.leeyong.klchwsc.adapter.MainAdapter;
import com.qujing.leeyong.klchwsc.fragment.HomeFragment;
import com.qujing.leeyong.klchwsc.fragment.NewsFragment;
import com.qujing.leeyong.klchwsc.fragment.SportFragment;
import com.qujing.leeyong.klchwsc.fragment.UserFragment;
   ...
   private TextView title;
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem( R.drawable.ic_home, "最新开奖").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_sport, "篮球赛事").setActiveColorResource(R.color.colorPrimary))
