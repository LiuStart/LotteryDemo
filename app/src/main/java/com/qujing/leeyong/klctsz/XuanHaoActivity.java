...
import com.qujing.leeyong.klctsz.adapter.GridAdapter;
import com.qujing.leeyong.klctsz.bean.BlogModel;
import com.qujing.leeyong.klctsz.util.MyLogger;
...
public class XuanHaoActivity extends AppCompatActivity implements View.OnClickListener {
    /**
     * test
     */
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                if (count != 0) {
                    ...
                    Toast.makeText(XuanHaoActivity.this, "已经随机生成一注！", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getHtml() {
        new Thread() {
            @Override
            public void run() {
                mRequestQueue = Volley.newRequestQueue(XuanHaoActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.copy:
                ...
                cm.setText(qian+"\n"+hou);
                Toast.makeText(this, "已复制到系统剪贴板，可以发给朋友们了！", Toast.LENGTH_LONG).show();
                break;
        }
    }
}
