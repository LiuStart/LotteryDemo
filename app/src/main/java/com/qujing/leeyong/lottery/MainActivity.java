package com.qujing.leeyong.lottery;
...
import com.qujing.leeyong.lottery.adapter.MainAdapter;
import com.qujing.leeyong.lottery.fragment.HomeFragment;
import com.qujing.leeyong.lottery.fragment.NewsFragment;
import com.qujing.leeyong.lottery.fragment.SportFragment;
import com.qujing.leeyong.lottery.fragment.UserFragment;
...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener,OnMenuItemClickListener, OnMenuItemLongClickListener, BottomNavigationBar.OnTabSelectedListener {
   ...
   private TextView title;
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem( R.drawable.ic_home_black_24dp, "首页开彩").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_fiber_new_black_24dp, "财经资讯").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_directions_bike_black_24dp, "竞技体育").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_person_black_24dp, "用户中心").setActiveColorResource(R.color.colorPrimary))
