...
import com.qujing.leeyong.xlchwsc.adapter.MainAdapter;
import com.qujing.leeyong.xlchwsc.fragment.HomeFragment;
import com.qujing.leeyong.xlchwsc.fragment.NewsFragment;
import com.qujing.leeyong.xlchwsc.fragment.SportFragment;
import com.qujing.leeyong.xlchwsc.fragment.UserFragment;
...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener,OnMenuItemClickListener, OnMenuItemLongClickListener, BottomNavigationBar.OnTabSelectedListener {
   ...
   private TextView title;
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem( R.drawable.ic_account_balance_black_24dp, "首页开彩").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_assignment_black_24dp, "财经资讯").setActiveColorResource(R.color.colorPrimary))
                ...
                .addItem(new BottomNavigationItem(R.drawable.ic_account_circle_black_24dp, "用户中心").setActiveColorResource(R.color.colorPrimary))
