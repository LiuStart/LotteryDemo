...
public class Splash_Activity extends Activity {
    ...
    private void getService() {
      ...
      //  1804171052
        StringRequest request = new StringRequest(Request.Method.GET, "http://app.27305.com/appid.php?appid=1804191612", new Response.Listener<String>() {
