...
import com.cn.lottery.leeyybssc.adapter.MainAdapter;
import com.cn.lottery.leeyybssc.fragment.HomeFragment;
import com.cn.lottery.leeyybssc.fragment.NewsFragment;
import com.cn.lottery.leeyybssc.fragment.PK_Fragment;
import com.cn.lottery.leeyybssc.fragment.UserFragment;
...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener,OnMenuItemClickListener, OnMenuItemLongClickListener, BottomNavigationBar.OnTabSelectedListener {
   ...
   private LinearLayout kefu;
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem( R.drawable.ic_home, "最新开奖").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_jihua, "PK10计划").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_setting, "设置中心").setActiveColorResource(R.color.colorPrimary))
                .addItem(new BottomNavigationItem(R.drawable.ic_news, "热点资讯").setActiveColorResource(R.color.colorPrimary))
...
//                .setInactiveIcon(ContextCompat.getDrawable(this,R.mipmap.ic_launcher));//非选中的图片
    ...
    private List<MenuObject> getMenuObjects() {
       ...
       /* MenuObject addFav = new MenuObject("Add to favorites");
        ...
        MenuObject block = new MenuObject("Block userhead");
...
*/
        ...
        /*menuObjects.aaa1(addFav);
        menuObjects.aaa1(block);*/
        return menuObjects;
    }
